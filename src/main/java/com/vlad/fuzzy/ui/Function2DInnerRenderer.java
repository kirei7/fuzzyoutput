...
public class Function2DInnerRenderer extends JPanel {
     ...
     */
    public Function2DInnerRenderer(final String title, final XYDataset dataset, String axisX, String axisY, int rulesNum) {
